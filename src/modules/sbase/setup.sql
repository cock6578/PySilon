...
drop policy if exists slots_owner_select on public.device_slots;
create policy slots_owner_select
...
create or replace function public.release_device_slot(p_device_id uuid)
returns void
language plpgsql
security definer
set search_path = public
...
'Authorization matrix used by private Realtime channels.';